...
\begin{figure}
    \centering
    \includegraphics[width=0.45\linewidth]{figures/test_flavor_plot.png}%
    \includegraphics[width=0.45\linewidth]{figures/bowtie.png}
    \caption{(left) The predicted astrophysical flavor ratios at the Earth given different neutrino production mechanisms. (right) the flavor bowtie for a 3-neutrino oscillations, and 3+ neutrino oscillations, from Ref~\cite{Arg_elles_2020_astrotime}.}\label{fig:flavor_triangle_points}
\end{figure}
