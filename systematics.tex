...
In one, a sample was generated while allowing the amplitudes and phases, for a Fourier series describing the depth-dependence of the absorption length and scattering length, to vary. 
This is described in detail in Subsection~\ref{sec:bulk}.
In the other sample the DOM efficiency and both unified hole ice parameters were allowed to vary. 
...
\begin{table}
    ...
    \begin{tabular}{c | ccc}\rowcolor{blue!25}
        {\large \textbf{Parameter}} & {\large \textbf{Center}} & {\large \textbf{Prior}} & {\large \textbf{Boundary}} \\\hline
        ...
        daemon\_0$^{*}$  & 0.0 & $0.0\pm1.0$ & [-4, 4]\\
        daemon\_1$^{*}$  & 0.0 & $0.0\pm1.0$ & [-4, 4]\\
        daemon\_9$^{*}$  & 0.0 & $0.0\pm1.0$ & [-4, 4]\\
        daemon\_12$^{*}$  & 0.0 & $0.0\pm1.0$ & [-4, 4]\\
        daemon\_18$^{*}$ & 0.0 & $0.0\pm1.0$ & [-4, 4]\\
        daemon\_19$^{*}$ & 0.0 & $0.0\pm1.0$ & [-4, 4]\\
        daemon\_20$^{*}$ & 0.0 & $0.0\pm1.0$ & [-4, 4]\\
        daemon\_23$^{*}$ & 0.0 & $0.0\pm1.0$ & [-4, 4]\\
        ...
        hole\_ice\_scale & -1.0 & $-1\pm10$ & [-4, 1]\\
        holeice p$_{0}$ & 0.0 & $0\pm 1.0$ & [-4,4]\\
        holeice p$_{1}$ & 0.0 & $0\pm 1.0$ & [-4,4]\\
        ice\_0$^{\ddag}$ & 0.0 & $0\pm 1.0$ & [-4,4]\\
        ice\_1$^{\ddag}$ & 0.0 & $0\pm 1.0$ & [-4,4]\\
        ice\_4$^{\ddag}$ & 0.0 & $0\pm 1.0$ & [-4,4]\\
        ice\_6$^{\ddag}$ & 0.0 & $0\pm 1.0$ & [-4,4]\\
        ice\_grad\_0\_rotated$^{**}$ & 0.0 & $0\pm 1.0$ & [-4,4]\\
        ice\_grad\_0\_rotated$^{**}$ & 0.0 & $0\pm 1.0$ & [-4,4]\\
