...
To address these particularly complex source of systematic uncertainty, a new method for efficiently determining the effects of these parameters was developed for IceCube analyses and published in Reference~\cite{Aartsen_2019_snow}: SnowStorm\footnote{The name SnowStorm reflects the idea that each event in the sample is distinct, like each snowflake in a snowstorm.}
