...
In spite of this, several anomalies exist in short-range neutrino oscillations experiments; several of which could be explained by additional oscillations of unknown neutrino mass and flavor eigenstates with eV$^{2}$-scale mass squared differences from the known active states~\cite{abazajian2012light}. 
In order to be consistent with measurements of Z-boson decay~\cite{zboson2006}, any new flavor state would need to be non weakly-interacting, or ``sterile''. 
The model satisfying these criteria is the ``3+1'' light sterile neutrino model, in which only a single sterile neutrino is added to the three-neutrino paradigm. 
...
Either flavor eigenstate can also expressed in the mass-basis as a linear superposition of the mass states. 
These relations are encoded in the unitary\footnote{neutrino number needs to be conserved.} PMNS matrix, 
\begin{equation}
...
MSW matter effects can yield a near complete disappearance of TeV-energy muon anti-neutrinos, passing through the Earth's core, for eV-scale sterile neutrino models~\cite{Nunokawa:2003ep, Petcov:2016iiu, Choubey:2007ji, Barger:2011rc, Esmaili:2012nz, esmaili2013restricting, Lindner:2015iaa}.
This is of particular interest to large-volume Cherenkov neutrino observatories, like the IceCube Neutrino Observatory, which have relatively high effective areas for through-going muons at those energies.
Recent results from IceCube, searching for such a signature, have already found suggestive results with closed contours at the 90\% confidence level and a best fit point at $\sin^2 2\theta_{24}\sim0.1$ and $\Delta m^2_{41}=4.5\text{ eV}^2$~\cite{Aartsen_2020, Aartsen_2020_prd}. 
