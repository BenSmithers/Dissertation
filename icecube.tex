...
\index{IceCube Neutrino Observatory}Described at length in Ref.~\cite{Aartsen_2017}, the IceCube Neutrino Observatory is a gigaton-scale Cherenkov observatory instrumented across a cubic kilometer, two kilometers deep, in the Antarctic glacial ice~\cite{Aartsen_2017}.
...
The resulting, \textit{clathrate} ice boasts good optical properties, where the optical defects are characterized instead by microscopic grains of dust and pollutants. \index{ice!bulk}
